...
public:
    ...
    //  METHODS  //
    Entity();
    Entity(GLuint texture_id, float speed, glm::vec3 acceleration, float jump_power, int walking[6][6], float animation_time,
    ...
    // Update the set_walking method to handle both 4x3 and 4x4 arrays
    ...
    // Overloaded version for 4x3 arrays
